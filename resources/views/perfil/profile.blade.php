                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex gap-2">
                            <button onclick="toggleEditBio()" class="flex items-center gap-2 px-3 py-1 rounded bg-blue-100 text-blue-600 hover:bg-blue-200 transition-colors">
                                <i class="fas fa-markdown"></i> Edit
                            </button>
                            <button id="saveBioButton" onclick="saveBio()" class="hidden px-3 py-1 rounded bg-green-100 text-green-600 hover:bg-green-200 transition-colors">
                                Save
                            </button>
                        </div>
                    </div>
            ...
            <div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="text-center p-3 bg-gray-50 rounded-lg">
                            <div class="text-sm font-medium text-blue-600">{{ \Carbon\Carbon::parse($user->stats->createdAt)->format('M Y') }}</div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div class="flex flex-col gap-3">
                        <a href="{{ $user->socials->github }}" class="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors" target="_blank" rel="noopener noreferrer">
                            <i class="fab fa-github"></i> GitHub
                        </a>
                        <a href="{{ $user->socials->twitter }}" class="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors" target="_blank" rel="noopener noreferrer">
                            <i class="fab fa-twitter"></i> Twitter
                        </a>
                        <a href="{{ $user->socials->linkedin }}" class="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors" target="_blank" rel="noopener noreferrer">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="group relative">
                            <div class="aspect-w-16 aspect-h-9 mb-2">
                                <img src="{{ $article->thumbnail }}" alt="{{ $article->title }}" class="rounded-lg object-cover w-full h-32" />
                            </div>
                            <h3 class="font-medium text-gray-900 group-hover:text-blue-600 transition-colors">{{ $article->title }}</h3>
                            <p class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($article->publishedAt)->format('M d, Y') }}</p>

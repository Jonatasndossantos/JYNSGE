...
<script src="https://unpkg.com/@tailwindcss/browser@4"></script>
        ...
        <div class="relative min-h-[35rem] w-full bg-default text-primary -mt-116 md:-mt-120"
                ...
                <div class="relative z-10"> 
                    ...
                    <div class="absolute inset-0 overflow-hidden transform-gpu h-[50vh] md:h-[60vh] lg:h-[70vh]"
                        style="background: url('{{URL ()}} no-repeat center center; background-size: cover; max-height: 800px;">
                ...
                <div class="sticky bottom-0 inset-x-0 transform-gpu aspect-1/1 lg:aspect-16/9 translate-y-hero-media-sm"
                    ...
                    <div class="w-8-cols md:w-6-cols-vw lg:w-8-cols-vw h-full mx-auto" data-homehero-media-inner=""
                        ...
                        <div class="h-full overflow-hidden mt-20 md:mt-0" data-behavior="VideoToggle"> 
                            ...
                            <video autoplay="" muted="" loop="" playsinline=""
                                src="{{URL ('assets/media/Projeto Redimensionar vídeo.mp4')}}"
                                class="lg:hidden w-full h-full   mt-40 " 
                                data-videotoggle-video=""
                                data-homehero-media="">
                                Your browser does not support the video tag.
                            </video>
                                            ...
                                            <div class="flex flex-col h-full">
                                                ...
                                                <div class="flex flex-col flex-grow">
                                                    ...
                                                    <div class="mt-16 text-secondary f-body-2">
                                                        <p>Coisas incríveis já estão em andamento no maior e mais influente evento de conectividade do mundo.
                                                            <br><br><br>
                                                            <strong>
                                                                3  a  6  de março  de 2025<br> Fira Gran Vía, Barcelona</strong>
                                                        </p>
                                                    </div>
    ...
    <section class="">
        ...
        <div class="container">
             <ul class="grid grid-cols-1 lg:grid-cols-3 gap-space-1 gap-y-8"> <!-- Adicionado gap-y-8 para espaçamento vertical -->
                 @foreach($noticiasRecentes as $noticia)
                            <li class="">
                                <div class="relative flex flex-col h-full rounded-lg bg-layer text-primary transition p-16 md:px-24 lg:pb-24 lg:px-16 group/card">
                                    <a href="{{ route('topicos.noticias', $noticia->id) }}"
                                        class="absolute inset-0 after:content-[''] after:absolute after:inset-0 after:z-1"
                                        aria-label="{{ $noticia->titulo }}"></a>

                                    <div class="grid grid-cols-1 lg:flex lg:flex-col lg:h-full gap-x-gutter md:grid-cols-2">
                                        ...
                                        <div class="flex flex-col flex-grow">
                                            <div class="flex gap-2 mb-space-3">
                                                @foreach($noticia->categorias as $categoria)
                                                <span class="block f-ui-1 text-tertiary">
                                                    {{ $categoria->nome }}
                                                </span>
                                                @endforeach
                                            </div>
                                            ...
                                            <div class="mt-16 text-secondary f-body-2">
                                                <p>{{ Str::limit($noticia->resumo, 150) }}</p>
                                            </div>
                                            ...
                                            <div class="mt-auto pt-space-6">
                                                <span class="inline-flex justify-end items-center transition-all duration-100 data-[focus-method=key]:focus:outline data-[focus-method=key]:focus:outline-2 data-[focus-method=key]:focus:outline-offset-2 data-[focus-method=key]:focus:outline-interactive-accent whitespace-nowrap disabled:opacity-30 disabled:pointer-events-none rounded-full w-40 h-40 text-primary hover:bg-mix-layer-8 active:bg-mix-layer-12 border-1.5 border-strong f-ui-1 overflow-hidden"
                                                    aria-hidden="true">
                                                    <span class="flex -mr-1 group-hover/card:translate-x-1/2 group-hover/card-feature:translate-x-1/2 transition-all duration-300 ease-expressive-standard">
                                                        <span class="flex justify-center w-40">
                                                            <svg width="24" height="24" aria-hidden="true">
                  ...
                  @endforeach
                    ...
                    <div class="block-container-full">
                    @include('components.lancamentos', ['noticiasArtificial' => $noticiasArtificial])
